...
// SetFields adds the fields to the get events params
func (o *GetEventsParams) SetFields(fields []string) {
	o.Fields = fields
}
...
// WithParkCode adds the parkCode to the get events params
func (o *GetEventsParams) WithParkCode(parkCode []string) *GetEventsParams {
	o.SetParkCode(parkCode)
	return o
}

// SetParkCode adds the parkCode to the get events params
func (o *GetEventsParams) SetParkCode(parkCode []string) {
	o.ParkCode = parkCode
}

// WithQ adds the q to the get events params
func (o *GetEventsParams) WithQ(q *string) *GetEventsParams {
	o.SetQ(q)
	return o
}

// SetQ adds the q to the get events params
func (o *GetEventsParams) SetQ(q *string) {
	o.Q = q
}
...
func (o *GetEventsParams) WithStart(start *int64) *GetEventsParams {
	o.SetStart(start)
	return o
}

// SetStart adds the start to the get events params
func (o *GetEventsParams) SetStart(start *int64) {
	o.Start = start
}

// WithStateCode adds the stateCode to the get events params
func (o *GetEventsParams) WithStateCode(stateCode []string) *GetEventsParams {
	o.SetStateCode(stateCode)
	return o
}

// SetStateCode adds the stateCode to the get events params
func (o *GetEventsParams) SetStateCode(stateCode []string) {
